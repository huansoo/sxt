...
public class JsonUtil
{
    ...
    * @Description: 获取类及父类中属性列表
    * @author lijun
    * @param bean 类对象
    * @param excludes 不包含的属性列表
    * @return
    * @throws
     */
    public static String[] getClassFields(Class<?> t, String[] excludes){
...
//          System.out.println(field.getName());
    ...
    public static String beanToJson(Object bean, String[] _nory_changes, boolean nory) {
        ...
        if(nory){//转换_nory_changes里的属性
            ...
            json = JSONObject.fromObject(bean, 
                        configJson(getClassFields(bean.getClass(), _nory_changes)));
    ...
    * @throws
    ...
    public static String beanListToJsonArray(List beans) {
