	...
	<script type="text/javascript">
			...
			$(function(){
					$('#t_emp').datagrid({
							...
							url:'Employee_getOnEmployeeList.action',	//远程加载数据的地址
							...
							columns:[[
								{field:'ename' , title:'员工姓名' , width: '100' , rowspan:2,align:'center', sortable: true , editor:'text' },
							...
							onBeforeEdit:function(index,row){  
        						row.editing = true;  
       							$('#t_emp').datagrid('refreshRow', index);  
    						},  
		    ...
		    function editrow(index){  
		        $('#t_emp').datagrid('beginEdit', index);  
		    }  
		    function deleterow(index){  
		        $.messager.confirm('Confirm','Are you sure?',function(r){  
		            if (r){  
		                $('#t_emp').datagrid('deleteRow', index);  
		            }  
		        });  
		    }  
		    function saverow(index){  
		        $('#t_emp').datagrid('endEdit', index);  
		    }  
		    function cancelrow(index){  
		        $('#t_emp').datagrid('cancelEdit', index);  
		    }  
