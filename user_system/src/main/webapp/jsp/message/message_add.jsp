...
<html>
  <head>
	...
	<!--
		//window.UEDITOR_HOME_URL = '/SXTManager/js/ueditor/'; //location.pathname.substr(0, location.pathname.lastIndexOf('/')) + '/';
	//-->
	</script>	
		...
		collapsible="true" maximizable=true >
			<form id="myform" action="Message_sendMessage.action" method="post" onsubmit="return checkForm();" >
				...
				<table>
						<tr>
							<td>标题</td>
							<td><input type="text" name="message.title" class="easyui-validatebox" required="true" missingMessage="该字段必填" size="30" value=""  /></td>
							<td>收件人</td>
							<td><input type="text" id="receiverNames" name="receiverNames" class="easyui-validatebox" required="true" missingMessage="该字段必填" value="" size="30" /> <input type="button" onclick="showDialog();" value="选择"/></td>
 					<div id="mydiv" class="easyui-dialog" title="选择收信人" style="padding: 10px;width: 500;height:400;" 
						...
						<tr>
							<td>信件内容</td>
							<td colspan="3">
							<!-- <script type="text/plain" id="editor" name="message.content" style="float:left"></script> -->
								<textarea id="editor" name="message.content"></textarea>
							</td>
						</tr>							
						<tr>
							<td colspan="4" align="center"><input id="subform" type="submit" value="发送"></td>
						</tr>						
				</table>
			</form>	
