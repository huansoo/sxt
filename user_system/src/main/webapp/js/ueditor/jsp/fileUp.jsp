    ...
    //仅做示例用，请自行修改
    //保存文件路径
    String filePath = "uploadfiles";	//修改真实路径. edit by oiyc
    ...
    if(ServletFileUpload.isMultipartContent(request)){
        ...
        System.out.println(filePath.substring(filePath.lastIndexOf("/")+1,filePath.length())+"/"+fileName+"','fileType':'"+contentType);
        
       response.getWriter().print("{'url':'"+url.substring(url.lastIndexOf("\\")+1,url.length())+"','fileType':'"+contentType+"','state':'"+state+"','original':'"+fileName+"'}");
    }
    %>
