...
public class MailSender {
        ...
        try
        {
            if (server.isValidate()) {
                auth = new MailAuth(server.getServerAddress(),
                        Base64Encry.decryptBASE64(server.getPassword()));
            }
	...
	*
	...
	public static void main(String[] args) throws Exception {
		MailServer server = new MailServer("smtp.exmail.qq.com","lijun@wugu.com.cn","吾谷网","wugu123", "/webapps/zhaopin/WEB-INF/pages");
	    ...
	    mailInfo.addToAdress(new Person("李军", "lijun@wugu.com.cn"));
	    mailInfo.addCcAdress(new Person("李军", "33291349@qq.com"));
	    mailInfo.addBccAdress(new Person("李军", "wanwangzhiwang@msn.com"));
	    mailInfo.addAtch("D:\\work\\志晴短信\\SDK使用说明-websever-更新-7-15.doc");
